...
void solve(){
    vector<int>v {1,2,10,13,20,20,20,30,40};
    cout<<lower_bound(v.begin(),v.end(),20) - v.begin()<<endl;
    cout<<lower_bound(v.begin(),v.end(),21) - v.begin()<<endl;
    cout<<lower_bound(v.begin(),v.end(),100) - v.begin()<<endl;  //prints 9 which is v.end()
